    ...
    <div class="card shadow m-auto w-75 p-5 rounded-0">
       <div class="row">
           <div class="col-md-8 border-right">
              ...
              <hr class="mt-1">
              <h4 class="font-weight-bold mt-4 ml-3">Sign Up</h4>
              <h5 class="ml-3">to access CRM</h5>
              <form class="mt-5">
                  <input type="text" name="nam" placeholder="Enter Your Name" class="form-control p-4 ml-3 w-75 bg-light">
                  <input type="text" name="eml" placeholder="Email address or mobile number" class="form-control p-4 ml-3 w-75 bg-light mt-3">
                  <input type="Password" name="pswd" placeholder="Enter Your Password" class="form-control p-4 ml-3 w-75 bg-light mt-3">
                  <input type="Password" name="pswd1" placeholder="Enter Confirm Password" class="form-control p-4 ml-3 w-75 bg-light mt-3">
                  <button class="butn text-center text-white font-weight-bold p-3 border-0 rounded mt-5 w-75 ml-3">Register</button>
              </form>
           </div>
           <div class="col-md-4">
