                          ...
                          <div class="col-md-5 offset-md-1 mt-3">
                            <form action="/action_page.php">
                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="offset-1 col-sm-2 text-right">
                                    <label for="exampleInputEmail1">Payment Metod </label>
                                  </div>
                                  <div class="col-sm-7">
                                    <div class="input-group">
                              ...
                              <div class="form-group row">
                                  <label for="staticEmail" class="text-right col-sm-3 col-form-label font-weight-bold">Attachment <sup class="a1">*</sup></label>
                                  <div class="col-sm-6">
                                      <input type="file" class="text-right form-control border-0 d-none" id="img" placeholder="">
                                  <label for="img" class="border w-50 pl-3">Select File</label>
                                  </div>
