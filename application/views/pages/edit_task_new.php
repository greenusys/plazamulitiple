...
<!--                   <li class="nav-item ">
        ...
        <div class="offset-1 col-sm-8 cl-md-8 col-lg-8">
          <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="task_name" class="form-control" value="<?=$task_details[0]['task_name']?>" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
            </div>
          </div>
<!--           <div class="form-group">
...
<!--           <div class="form-group related_to_task">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-9">
                    ...
                    <div class='input-group date datetimepicker1' id='datetimepicker1'>
                        <input type='text' name="task_start_date" data-date-format="YYYY-mm-DD" value="<?=$task_details[0]['task_start_date']?>" class="form-control" />
          ...
          <div class="form-group">
              ...
              <div class="col-sm-9">
                 <div class='input-group date datetimepicker1' id=''>
                        <input type='text' name="due_date" value="<?=$task_details[0]['due_date']?>" data-date-format="YYYY-mm-DD" class="form-control" />
                        <span class="input-group-addon">
                            <span ><i class="fa fa-calendar"></i></span>
                        </span>
                    </div>
          ...
          <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="number" name="hourly_rate" step="0.01" value="<?=$task_details[0]['hourly_rate']?>" class="form-control" name="estimate_hours" data-parsley-id="23">
              </div>
            </div>
          </div>
          <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="number" name="task_hour" step="0.01" value="<?=$task_details[0]['task_hour']?>" class="form-control" name="estimate_hours" data-parsley-id="23">
              </div>
            </div>
          </div>
...
<!--           <div class="form-group">
              ...
              <div class="col-sm-9">
                <div class="input-group">
                    <select name="task_status" class="form-control" id="task_status">
                       <option value="not_started" <?php if ($task_details[0]['task_status']=="not_started") {
                         echo "selected";
                       }?>>Not Started </option>
                        <option value="in_progress" <?php if ($task_details[0]['task_status']=="in_progress") {
                         echo "selected";
                       }?>>In progress</option>
                        <option value="completed" <?php if ($task_details[0]['task_status']=="completed") {
                         echo "selected";
                       }?>>Completed</option>
                        <option value="deferred" <?php if ($task_details[0]['task_status']=="deferred") {
                         echo "selected";
                       }?>>Deferred</option>
                        <option value="waiting_for_someone" <?php if ($task_details[0]['task_status']=="waiting_for_someone") {
                         echo "selected";
                       }?>>Waiting For Someone</option>
                    </select>
                    <input type="hidden" name="task_id" value="<?=$this->uri->segment(3)?>">
                </div>
              </div>
            </div>
          </div>
          <div class="form-group">
              ...
              <div class="col-md-9">
                 <textarea name="editor1"><?=$task_details[0]['task_description']?></textarea>
                <script>
...
<script type="text/javascript">
        $("#create_task").submit(function(e){
         ...
         $.ajax({
             url:"<?=base_url()?>Task/task_update_main",
              type:"post",
              data:formData,
              contentType:false,
              processData:false,
             ...
             success:function(response)
             {
              //console.log(response);
               ...
               if(response==1){
                 swal("Task Updated Successfully!", "Updated", "success");
