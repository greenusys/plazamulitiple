<style>
  .w_20{
    width: 20px;
        ...
        <form  id="depttt">
          <?php
          foreach($Edit_Department as $flydata)
          {
          	 // print_r($flydata);
          ?>
          <div class="form-group">
            <div class="row">
             ...
             <div class="col-sm-7">
          	...
          	<input type="hidden" name="department_id" value="<?=$flydata->departments_id?>">
                 <input type="text" class="form-control " value="<?=$flydata->deptname?>" name="department">
      ...
      $('#datetimepicker10').datetimepicker({
       ...
       $(document).ready(function(){
            $("#depttt").submit(function(e){
                ...
                $.ajax({
                    url:"<?=base_url('Department/updatedepartmentsbyid')?>",
                     type:"post",
                     data:formData,
                    ...
                    success:function(response)
                    {
                     ...
                     if(obj.status==2)
                     {
                     swal("Department", "Try Again", "error")
                     }
