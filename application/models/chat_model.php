...
//        $this->db->where('deleted', 0);
    ...
    public function getConversation($user_id,$to_user_id){
        // $this->db->join('tbl_users', 'tbl_users.user_id = tbl_private_chat_messages.user_id', 'left');
        // $this->db->join('tbl_private_chat_users', 'tbl_private_chat_users.private_chat_id = tbl_private_chat_messages.private_chat_id', 'left');
        // $conditionOne=array("tbl_private_chat_users.user_id"=>$user_id,"tbl_private_chat_users.to_user_id"=>$to_user_id);
        // $conditionTwo=array("tbl_private_chat_users.to_user_id"=>$to_user_id,"tbl_private_chat_users.user_id"=>$user_id);
